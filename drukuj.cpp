...
void Drukuj::on_pushButton_Print_clicked()
{
	if (ui->radioButton_Akt->isChecked() == true)
	{
		...
		fnout << QString::fromWCharArray(L"<!DOCTYPE HTML><html><head><title>Biblioteka Filmów Wydruk danych z bazy - http://mkalat.pl</title><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"><style type=\"text/css\">p {font-family: Verdana, Arial, Helvetica, sans-serif;font-size: 12px;line-height : 1%;}</style></head><body><h1>") << "\n";
		...
		fnout << QString::fromWCharArray(L"\" alt=\"\"></td></tr><tr><td><p>Oryginalny tytuł: </p></td><td><p>").toUtf8();
		...
		fnout << QString::fromWCharArray(L"</p></td></tr><tr><td><p>Język lektora : </p></td><td><p>").toUtf8();
		fnout << QString::fromWCharArray(flm_d.film_tbl.IOF_jezyk_lektora).toUtf8();
		fnout << QString::fromWCharArray(L"</p></td></tr><tr><td><p>Język napisów </p></td><td><p>").toUtf8();
		fnout << QString::fromWCharArray(flm_d.film_tbl.IOF_jezyk_napisow).toUtf8();
		fnout << QString::fromWCharArray(L"</p></td></tr><tr><td><p>Format wyświetlania : </p></td><td><p>").toUtf8();
		...
		fnout << QString::fromWCharArray(L"</p></td></tr><tr><td><p>Wartość aktualna : </p></td><td><p>").toUtf8();
		...
		fnout << QString::fromWCharArray(L"</p></td></tr><tr><td><p>Nośnik : </p></td><td><p>").toUtf8();
		...
		fnout << QString::fromWCharArray(L"</p></td></tr><tr><td><p>Ocena - Zdjęcia : </p></td><td><p>").toUtf8();
		fnout << QString::fromWCharArray(flm_d.film_tbl.WOF_zdjecia).toUtf8();
		fnout << QString::fromWCharArray(L"</p></td></tr><tr><td><p>Ocena - Wartość artystyczna : </p></td><td><p>").toUtf8();
		fnout << QString::fromWCharArray(flm_d.film_tbl.WOF_w_art).toUtf8();
		fnout << QString::fromWCharArray(L"</p></td></tr><tr><td><p>Ocena - Całość : </p></td><td><p>").toUtf8();
		...
		fnout << QString::fromWCharArray(L"</p></td></tr><tr><td><p>Właściciel - Imię : </p></td><td><p>").toUtf8();
		fnout << QString::fromWCharArray(flm_d.film_tbl.DOE_WKF_imie).toUtf8();
		fnout << QString::fromWCharArray(L"</p></td></tr><tr><td><p>Właściciel - Nazwisko : </p></td><td><p>").toUtf8();
		fnout << QString::fromWCharArray(flm_d.film_tbl.DOE_WKF_nazwisko).toUtf8();
		fnout << QString::fromWCharArray(L"</p></td></tr><tr><td><p>Właściciel - Adres : </p></td><td><p>").toUtf8();
		...
		if (ui->checkBox_OB->isChecked() == true)
		{
			...
			for (unsigned int i = 0; i < stop; )
			{
				...
				{
					fnout << QString::fromWCharArray(L"<tr><td><p>Imię i Nazwisko : </p></td><td><p>").toUtf8();
		...
		if (ui->checkBox_OC->isChecked() == true)
		{
			...
			for (unsigned int i = 0; i < stop; )
			{
				...
				if (oc_buff.IDPDB == flm_d.film_tbl.ID)
				{
					...
					fnout << QString::fromWCharArray(L"</p></td></tr><tr><td><p>Tytuł tekstu : </p></td><td><p>").toUtf8();
		...
		if (ui->checkBox_PROD->isChecked() == true)
		{
			...
			for (unsigned int i = 0; i < stop; )
			{
				...
				if (p_buff.IDPDB == flm_d.film_tbl.ID)
				{
					...
					fnout << QString::fromWCharArray(L"</p></td></tr><tr><td><p>Nrodowość : </p></td><td><p>").toUtf8();
		...
		{
			fnout << QString::fromWCharArray(L"<h1>Tabela Lokalizacje zdjęciowe</h1><table >").toUtf8() << "\n";
			...
			for (unsigned int i = 0; i < stop; )
			{
				...
				if (z_buff.IDPDB == flm_d.film_tbl.ID)
				{
					...
					fnout << QString::fromWCharArray(L"</p></td></tr><tr><td><p>Miejscowość : </p></td><td><p>").toUtf8();
		...
		{
			fnout << QString::fromWCharArray(L"<h1>Tabela Wypożyczenia innym osobom</h1><table >").toUtf8() << "\n";
			...
			for (unsigned int i = 0; i < stop; )
			{
				...
				{
					fnout << QString::fromWCharArray(L"<tr><td><p>Data wypożyczenia : </p></td><td><p>").toUtf8();
					...
					fnout << QString::fromWCharArray(L"</p></td></tr><tr><td><p>Stan przed wypożyczeniem : </p></td><td><p>").toUtf8();
		...
		{
			fnout << QString::fromWCharArray(L"<h1>Tabela Wypożyczenia od innych osób</h1><table >").toUtf8() << "\n";
	...
	else if (ui->radioButton_All->isChecked() == true)
	{
		...
		fnout << QString::fromWCharArray(L"<!DOCTYPE HTML><html><head><title>Biblioteka Filmów - Wydruk danych z bazy - http://mkalat.pl</title><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"><style type=\"text/css\">p {font-family: Verdana, Arial, Helvetica, sans-serif;font-size: 12px;line-height : 1%;}</style></head><body>") << "\n";
				...
				if (ui->checkBox_DYSTR->isChecked() == true)
				{
					...
					for (unsigned int i = 0; i < stop; )
					{
						...
						if (d_buff.IDPDB == m_buff.ID)
						{
							...
							fnout << QString::fromWCharArray(L"</p></td></tr><tr><td><p>Strona WWW : </p></td><td><p>").toUtf8();
							fnout << QString::fromWCharArray(d_buff.strona_www).toUtf8();
							fnout << QString::fromWCharArray(L"</p></td></tr><tr><td><p>Narodowość : </p></td><td><p>").toUtf8();
							fnout << QString::fromWCharArray(d_buff.narodowosc).toUtf8();
							fnout << QString::fromWCharArray(L"</p></td></tr>").toUtf8();
						}
						i = i + sizeof(d_buff);
